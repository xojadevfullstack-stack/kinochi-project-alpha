  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-container-max mx-auto px-gutter w-full flex flex-col md:flex-row items-center md:items-end gap-margin-desktop">
          ...
          <div className="flex-1 flex flex-col w-full md:pb-stack-lg">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-stack-md font-label-caps text-label-caps tracking-widest uppercase text-xs">
              ...
              <KinochiRatingBadge 
                initialRating={series.kinochi_rating} 
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center md:justify-start">
              <a 
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 bg-primary-container text-white px-8 py-4 rounded-xl font-label-caps text-xs uppercase tracking-widest hover:bg-inverse-primary hover:scale-[1.02] hover:-translate-y-0.5 active:scale-95 shadow-lg shadow-primary-container/25 hover:shadow-primary-container/35 transition-all duration-200 group font-bold cursor-pointer"
              >
      ...
      <ReviewsSection
        ...
        initialKinochiRating={series.kinochi_rating}
        initialVotesCount={series.kinochi_votes_count || 0}
      />
    </>
  );
}
