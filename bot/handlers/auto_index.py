...
season_locks: dict[int, asyncio.Lock] = {}

def get_season_lock(season_id: int) -> asyncio.Lock:
    if season_id not in season_locks:
        season_locks[season_id] = asyncio.Lock()
    return season_locks[season_id]
