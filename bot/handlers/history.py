...
from app.core.watch_history import mark_movie_completed, mark_episode_completed
...
async def handle_ignore_history(callback: CallbackQuery):
    await callback.answer("Siz bu filmni yoki qismni allaqachon ko'rib bo'lgansiz.")
